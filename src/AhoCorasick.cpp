...
const std::vector<std::pair<size_t, size_t>> AhoCorasick::Search(const Text& text, const std::vector<Text>& PatternSet)
{
	std::vector<std::pair<size_t, size_t>> OccurencesSet;
